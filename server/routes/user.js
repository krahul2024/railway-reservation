...
router.post("/confirmReservation" , auth, async(req,res) => {
	...
	try{ 
			...
			for(let i=0;i<users.length;i++){
				...
				let user = users[i] , seat = emptySeats[emptySeats.length-1]
