					...
					<div className="m-auto px-24 py-8 w-full flex flex-col items-center shadow-2xl backdrop-brightness-125 rounded-xl">
						...
						<div className="p-2 m-2 flex flex-col justify-between">
							...
							<div className="flex flex-col p-2">
								...
								<button className="px-4 mx-2 cursor-pointer text-cyan-500 -ml-12"
							...
							<div className="flex flex-col justify-center items-center mt-8">
							  <button onClick={(e) => handleLoginInputs(e)}
							    className="w-full flex justify-center cursor-pointer px-28 py-1.5 border border-sky-700 hover:border-transparent hover:bg-blue-700 hover:text-gray-950 font-semibold text-gray-400 rounded-full w-fit"
							  >
							    Go
							  </button>
