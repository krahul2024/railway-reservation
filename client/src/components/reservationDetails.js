...
const ReservationDetails = () => {
	...
	if(location.state.train) return (<>  
		...
		<div className="shadow-2xl backdrop-brightness-200">

			<div className="flex flex-col shadow-2xl">
				<div className="flex justify-center gap-12 md:px-12 md:py-4 px-4 py-4 mt-4 text-cyan-500 brightness-125 font-semibold text-lg">
					<span>{train.number}</span>
					<span>{train.name}</span>
				</div>
				
				<div className="md:flex justify-center md:p-8 md:gap-16 font-semibold p-4">
					<div className="text-sky-500 brightness-125 gap-4">
					...
					<div className="text-indigo-600 brightness-125 md:p-0 p-4">
						<span className="flex justify-center p-4">To</span>
					</div>

					<div className="text-sky-600 brightness-125">
		...
		<div className="p-4 shadow-2xl">
			<div className="p-4 shadow-2xl flex flex-col">
				...
				<span className="flex justify-center text-indigo-600 font-semibold hover:text-red-700">Fare: Rs. {distance * (selectedClass.fareRatio?selectedClass.fareRatio:selectedClass.fairRatio)}</span>
			</div>
		</div>
		...
		<form action="" className="md:p-16 p-8">
			<div className="">
				<div className="flex justify-center items-center">
					<span className="p-2 font-semibold text-cyan-600 brightness-125 flex text-center">Please Enter following details for ticket booking.</span>
				</div>
				<div className="flex justify-center px-4 py-8">
					<div className=""> 
					 ...
					 <div className="flex flex-col py-8 rounded-lg">
					 	...
					 	<div key={index} className="grid md:grid-cols-2 lg:grid-cols-3 mt-8 shadow-2xl backdrop-brightness-125 rounded-xl p-4">
					 		<div className="p-2 flex flex-col">
						 		<span className="font-semibold text-sky-500">Name</span>
						 		<div className="flex gap-4">
						 			...
						 			<input type="text" name="name" value = {userItem.name} 
								 		...
								 		className="flex px-9 outline-0 bg-transparent border-b-2 hover:border-indigo-600 mt-1  w-[230px] md:w-[270px] border-cyan-700 text-indigo-500"
								 		/>
						 		</div>
						 	...
						 	<div className="p-2 flex flex-col">
						 		<span className="font-semibold text-sky-500">Age</span>
							 	<div className="flex gap-4">
						 			<span className="-mr-10 p-1 text-sky-500">
						 				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
										  <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
							 		...
							 		onChange = {event => handleUserInputs(event , index) }
							 		className="flex px-9 outline-0 bg-transparent border-b-2 hover:border-indigo-600 mt-1  w-[150px] md:w-[200px] border-cyan-700 text-indigo-500"
							 		/>
						 		</div>
						 	</div>
						 	<div className="p-2 flex flex-col ">
						 	...
						 	<div className="p-2 flex flex-col ">
						 		<span className="font-semibold text-sky-500">E-mail</span>
						 		<div className="flex gap-4">
						 			<span className="-mr-10 p-1 text-sky-500">
						 				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
						 			...
						 			<input type="text" value={userItem.email} name="email"
								 		onChange = {event => handleUserInputs(event , index) }
								 		className="flex px-9 outline-0 bg-transparent border-b-2 hover:border-indigo-600 mt-1  w-[200px] md:w-[240px] border-cyan-700 text-indigo-500"
								 		/>
						 		</div>
						 	</div>
						 	<div className="p-2 flex flex-col ">
						 		...
						 		<div className="flex gap-4">
						 			...
						 			<input type="text" value={userItem.address} name="address"
								 		onChange = {event => handleUserInputs(event , index) }
								 		className="flex px-9 outline-0 bg-transparent border-b-2 hover:border-indigo-600 mt-1  w-[400px] md:w-[320px] border-cyan-700 text-indigo-500"
								 		/>
						 		</div>
						 	</div>
						 	<div className=" flex flex-col justify-start mt-8 md:px-16">
						 		<button className="flex text-sky-600 hover:text-slate-950 items-center gap-3 backdrop-brightness-150 px-3 mx-auto py-2 border border-sky-700 hover:border-transparent hover:bg-indigo-800 text-b-400 hover:font-semibold rounded-full w-auto"
					 	...
					 	<div className="flex mt-8 shadow-2xl px-2 justify-start">
						 		<button className="flex text-sky-600 hover:text-slate-950 items-center gap-3 backdrop-brightness-150 px-6 mx-auto py-2 border border-sky-700 hover:border-transparent hover:bg-indigo-800 text-b-400 hover:font-semibold rounded-full w-auto"
