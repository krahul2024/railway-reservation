		...
		<div className=" py-4 backdrop-blur-3xl ">
			<form action="">
				{/*for showing train basic details*/}
					<div className="px-12 py-8 mb-8 shadow-2xl rounded-xl brightness-125 backdrop-brightness-200 contrast-100">
					...
					<div className="px-12 py-4 rounded-lg mt-2 flex flex-col items-center">
						...
						<div className="flex justify-center grid gap-4 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 py-4 px-2 shadow-2xl">
