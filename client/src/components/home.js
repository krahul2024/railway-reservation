...
const Home = () => {
	...
	const fetchClasses = async () => {
		try{
			const response = await fetch("http://localhost:4000/train/class_list",{
			method:'GET',
			headers:{
				"Content-Type":"application/json"
			}
	...
	const fetchTrains = async () => {
		try{
			const response = await fetch("http://localhost:4000/train/train_list",{
				method:"GET",
				headers:{
					"Content-Type":"application/json"
				}
	...
	const handleAllInputs = async (e) => {
		...
		const response = await fetch("http://localhost:4000/train/search_trains",{
			method:"POST",
			headers:{
				"Content-Type":"application/json"
			},
...
for(let i=0;i<current_date;i++) daysToHide.push(i) 
	...
	return ( <> 
		...
		<div className="p-12 flex flex-col justify-center text-center shadow-2xl backdrop-brightness-125">
				...
				<div className="md:flex mt-24 gap-12 justify-center shadow-2xl">
					<div className="flex flex-col p-4 mt-8 justify-center ">
						...
						<div className="flex items-center gap-3 ">
							...
							className="text-indigo-600 outline-0 border-b-2 mt-2 px-8 py-1 bg-transparent border-sky-700 shadow-md w-[260px] lg:w-[300px] hover:border-indigo-600"
							/>
							</div>
...
{/*----------------------------------------This section is for class selection-----------------------------------------------------*/}
				<div className="flex flex-col mt-8 p-2 justify-center md:px-10 px-4 shadow-2xl">
					...
					<div className="shadow-2xl flex items-center">
						...
						<MultiSelect 
						className="rmsc text-indigo-500 md:w-[300px] w-[280px] px-2 py-3 shadow-2xl "
						options = {classList}
						value={classes}
						onChange={setClasses}
...
{/*-----------------------------this section is for train name and number----------------------------------------------*/}
				<div className="md:flex md:gap-12 gap-4 mt-8 p-2 rounded-lg shadow-2xl">
					<div className="flex flex-col p-4 mt-8 justify-center ">
