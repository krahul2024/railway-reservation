	...
	return (<> 
		...
		<div>
			<div className="py-2 min-h-max shadow-2xl shadow-gray-800 items-center">
				<div className="flex gap-2 md:gap-8 justify-between px-12 xl:px-24 2xl:px-36 3xl:px-52">
					<NavLink to={"/"}
						className="flex gap-2 p-2 md:gap-4 items-center">
					...
					<div className="flex gap-2 md:gap-4 items-center">
						<div>
							<NavLink to="/pnr-status"
								className="p-1 m-1 text-sky-600 font-semibold text-md hover:text-sky-400 cursor-pointer">PNR-Status</NavLink>
						</div>

						<span className="text-sky-500 font-semibold text-lg flex gap-2">
							...
							<NavLink to={profile?"/user/profile":"/login"} className="text-sky-600 font-semibold text-md hover:text-sky-400 cursor-pointer">{profile?profile.name.split(" ")[0]+"..":"login"}</NavLink>
						</span>

						{profile === null && (
						<div>
							<NavLink to = {"/register"}
								className="p-1 m-1 text-sky-600 font-semibold text-md hover:text-sky-400 cursor-pointer">
								register</NavLink>
						</div>
						)}
						...
						<div>
							<span onClick = {(e) => processLogout(e) }
								className="p-1 m-1 text-sky-600 font-semibold text-md hover:text-sky-400 cursor-pointer">logout</span>
						</div>
						)}
