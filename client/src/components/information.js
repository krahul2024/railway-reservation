...
const Information = () => {
	...
	const deleteClass = async(e , index) => {
				e.preventDefault() 
		try{
			const response = await fetch("http://localhost:4000/train/delete_class",{
				method:"POST",
				credentials:"include",
				headers:{
					"Content-Type":"application/json"
	...
	const deleteStation = async(e , index) => {
				e.preventDefault() 
		try{
			const response = await fetch("http://localhost:4000/train/delete_station",{
				method:"POST",
				credentials:"include",
				headers:{
					"Content-Type":"application/json"
	...
	const deleteTrain = async(e , index) => {
				e.preventDefault() 
		try{
			const response = await fetch("http://localhost:4000/train/delete_train",{
				method:"POST",
				credentials:"include",
				headers:{
					"Content-Type":"application/json"
